...
class DiaryTests: XCTestCase {
    ...
    func testIsEp() throws {
        ...
        // // verify
        XCTAssertEqual(memoDiary.contentType().isEp, false)
        XCTAssertEqual(epDiary.contentType().isEp, true)
        XCTAssertEqual(unknownDiary.contentType().isEp, false)
    }
